...
import simple.example.hewanpedia.model.LumbaLumba;
...
public class DataProvider {
    ...
    private static List<LumbaLumba> initDataLumba(Context ctx) {
        List<LumbaLumba> lumbaLumbas = new ArrayList<>();
        lumbaLumbas.add(new LumbaLumba("Merah Muda", "Amazon",
                "LumbaLumba-LumbaLumba merah muda ini hidup di Sungai Amazon", R.drawable.lumba_lumba_sungai_amazon));
        lumbaLumbas.add(new LumbaLumba("Belang", "Samudera Atlantik, Samudera Pasifik, dan Samudera Hindia) ",
                "LumbaLumba-lumba belang merupakan salah satu lumba-lumba dengan daerah sebaran terluas", R.drawable.lumba_lumba_belang));
        lumbaLumbas.add(new LumbaLumba("Hidung Botol", "Indonesia",
                "LumbaLumba-lumba hidung botol adalah jenis lumba-lumba yang paling terkenal dan seringa ada di atraksi", R.drawable.lumba_lumba_hidungbotol));
        lumbaLumbas.add(new LumbaLumba("Pesut", "Mahakam",
                "Panjang tubuhnya sekitar 2,3 meter dengan berat 130 kg", R.drawable.lumba_lumba_pesut_mahakam));
        lumbaLumbas.add(new LumbaLumba("Gigi Kasar", "Jerman",
                "LumbaLumba-lumba gigi kasar memiliki ukuran mencapai 2,6 meter dengan berat sekitar 160 kg", R.drawable.lumba_lumba_gigi_kasar));
        lumbaLumbas.add(new LumbaLumba("Fraser", "Jepang",
                "LumbaLumba-lumba belag memiliki nama latin Stenella coeruleoalba di temukan pada tahun 1833 oleh Meyen", R.drawable.lumba_lumba_fraser));
        return lumbaLumbas;
    }
    ...
    private static void initAllHewans(Context ctx) {
        ...
        hewans.addAll(initDataLumba(ctx));
    }
